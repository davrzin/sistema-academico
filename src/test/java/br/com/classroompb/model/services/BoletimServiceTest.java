...
public class BoletimServiceTest {
    ...
    public void criarVariaveis(){
        ...
        boletimRepository = new BoletimRepository(new ObjectMapper(), DIRETORIO_BOLETINS.toString());
    ...
    public void deveLancarEntradaInvalidaExceptionEmCriarBoletimComBoletimNull(){
        ...
        Assertions.assertThrows(EntradaInvalidaException.class, () -> boletimService.criarBoletim(null));
    }
    ...
    public void deveLancarEntradaInvalidaExceptionAoBuscarBoletinsDeAlunoComMatriculaNull(){
        ...
        Assertions.assertThrows(EntradaInvalidaException.class, () -> boletimService.buscarBoletinsPorAluno(null));
    }
    ...
    public void deveLancarEntradaInvalidaExceptionAoBuscarBoletinsDeAlunoComMatriculaVazia(){
        ...
        Assertions.assertThrows(EntradaInvalidaException.class, () -> boletimService.buscarBoletinsPorAluno(""));
    }
