...
public class CursoTest {
  ...
  public void deveLancarExceptionNoConstrutorQuandoNomeVazio() {
    Assertions.assertThrows(EntradaInvalidaException.class, () -> new Curso("", 8, 3200));
  }
  ...
  public void deveLancarExceptionEmSetCodigoVazio() {
    Curso curso = new Curso("ESW001", "Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setCodigo(""));
  }

  @Test
  public void deveLancarExceptionEmSetCodigoNulo() {
    Curso curso = new Curso("ESW001", "Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setCodigo(null));
  }
  ...
  public void deveLancarExceptionEmSetNomeVazio() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setNome(""));
  }

  @Test
  public void deveLancarExceptionEmSetNomeNulo() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setNome(null));
  }

  @Test
  public void deveLancarExceptionEmSetNomeMuitoCurto() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setNome("AB"));
  }
  ...
  public void deveLancarExceptionEmSetNomeMuitoLongo() {
    ...
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setNome(nomeLongo));
  }
  ...
  public void deveLancarExceptionEmSetQuantidadePeriodosZero() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setQuantidadePeriodos(0));
  }

  @Test
  public void deveLancarExceptionEmSetQuantidadePeriodosNegativo() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setQuantidadePeriodos(-1));
  }

  @Test
  public void deveLancarExceptionEmSetQuantidadePeriodosAcimaDoLimite() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setQuantidadePeriodos(14));
  }
  ...
  public void deveLancarExceptionEmSetCargaHorariaZero() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setCargaHorariaTotal(0));
  }

  @Test
  public void deveLancarExceptionEmSetCargaHorariaNegativa() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(EntradaInvalidaException.class, () -> curso.setCargaHorariaTotal(-100));
  }
  ...
  public void deveLancarExceptionEmSetCargaHorariaAcimaDoLimite() {
    Curso curso = new Curso("Engenharia de Software", 8, 3200);
    Assertions.assertThrows(
        EntradaInvalidaException.class, () -> curso.setCargaHorariaTotal(10001));
  }
