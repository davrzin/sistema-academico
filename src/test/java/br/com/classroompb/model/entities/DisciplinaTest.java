...
public class DisciplinaTest {
    ...
    public void deveCriarDisciplinaComSeisParametros() {
        Disciplina disciplina = new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO);
        Assertions.assertEquals(Disciplina.class, disciplina.getClass());
    }

    @Test
    public void deveCriarDisciplinaComSeteParametros() {
        Disciplina disciplina = new Disciplina("DIS001", NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO);
        Assertions.assertEquals(Disciplina.class, disciplina.getClass());
    }
    ...
    public void deveCriarDisciplinaComPreRequisitosPreenchidos() {
        ...
        Disciplina disciplina = new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, preReqs);
    ...
    public void deveLancarExceptionNoConstrutorQuandoNomeVazio() {
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> new Disciplina("", CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO));
    }

    @Test
    public void deveLancarExceptionNoConstrutorQuandoCargaHorariaZero() {
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> new Disciplina(NOME_VALIDO, 0, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO));
    }

    @Test
    public void deveLancarExceptionNoConstrutorQuandoPeriodoZero() {
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> new Disciplina(NOME_VALIDO, CARGA_VALIDA, 0, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO));
    }

    @Test
    public void deveLancarExceptionNoConstrutorQuandoCreditosZero() {
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, 0, COD_CURSO_VALIDO, PRE_REQ_VAZIO));
    }

    @Test
    public void deveLancarExceptionNoConstrutorQuandoCodigoCursoVazio() {
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, "", PRE_REQ_VAZIO));
    }
    ...
    public void deveLancarExceptionEmSetNomeMuitoLongo() {
        Disciplina disciplina = new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO);
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> disciplina.setNome("A".repeat(201)));
    }
    ...
    public void deveLancarExceptionEmSetCargaHorariaAcimaDoLimite() {
        Disciplina disciplina = new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO);
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> disciplina.setCargaHoraria(301));
    }
    ...
    public void deveLancarExceptionEmSetCodigoCursoNulo() {
        Disciplina disciplina = new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO);
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> disciplina.setCodigoCurso(null));
    }
    ...
    public void deveLancarExceptionEmSetCodigoCursoFormatoInvalido() {
        Disciplina disciplina = new Disciplina(NOME_VALIDO, CARGA_VALIDA, PERIODO_VALIDO, CREDITOS_VALIDOS, COD_CURSO_VALIDO, PRE_REQ_VAZIO);
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> disciplina.setCodigoCurso("ESW001"));
    }
    ...
    public void deveLancarExceptionEmSetCodigoCursoComDigitoInsuficiente() {
        ...
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> disciplina.setCodigoCurso("cur1"));
    }
    ...
    public void deveLancarExceptionEmSetPreRequisitosComItemVazio() {
        ...
        Assertions.assertThrows(EntradaInvalidaException.class,
                () -> disciplina.setPreRequisitos(preReqsInvalidos));
    }
