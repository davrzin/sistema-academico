...
public class AulaTest {
  ...
  /**
   * Prepara uma aula para os testes.
   */
  @BeforeEach
  ...
  public void deveLancarNullPointerExceptionComConstrutorCompleto() {
    Assertions.assertThrows(
        EntradaInvalidaException.class, () -> new Aula(null, null, null, null, null));
  }
  ...
  public void deveRetornarDataAula() {
    ...
    Assertions.assertEquals(
        LocalDate.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")), aulaTeste.getData());
  }
